  ...
  <div class="col-md-6">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
      <div class="col p-4 d-flex flex-column position-static">
        <strong class="d-inline-block mb-2 text-primary-emphasis">Foto Teman Saya 1</strong>
        <h3 class="mb-0">Bradley</h3>
        <div class="mb-1 text-body-secondary">Hari ini</div>
        <p class="card-text mb-auto">Di sebelah kanan merupakan foto teman saya</p>
      ...
      <div class="col-auto d-none d-lg-block">
        <img src="/img/egg.jpeg" class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg"
  ...
  <div class="col-md-6">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
      <div class="col p-4 d-flex flex-column position-static">
        ...
        <h3 class="mb-0">Bradley</h3>
        <div class="mb-1 text-body-secondary">Hari ini</div>
        <p class="mb-auto">Di sebelah kanan merupakan foto teman saya juga</p>
        <a href="foto.php" class="icon-link gap-1 icon-link-hover stretched-link">
          Continue reading
          <svg class="bi">
            <use xlink:href="#chevron-right" />
      ...
      <div class="col-auto d-none d-lg-block">
        <img src="/img/bill.jpeg" class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg"
          role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#55595c" /></img>
      </div>
    ...
    <article class="blog-post">
      ...
      <ul>
        ...
        <li><del>Deleted</del> text should use <code class="language-plaintext highlighter-rouge">&lt;del&gt;</code>
          and <ins>inserted</ins> text should use <code class="language-plaintext highlighter-rouge">&lt;ins&gt;</code>.
        </li>
