<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <h5 class="text-uppercase">Tentang Saya</h5>
            <p>Halo! Saya seorang blogger yang suka berbagi cerita, pengalaman, dan wawasan seputar teknologi,
                perjalanan, dan kehidupan sehari-hari.</p>
        </div>
    ...
    <div class="text-center mt-4">
        <small>&copy; 2025 Blog Pribadi. Semua Hak Dilindungi.</small>
    </div>
</div>